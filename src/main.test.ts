...
it("1. add function test that fails", () => {
  expect(sum()).toBe(0);
});

it("2. should return the same number when input is one number", () => {
    expect(sum("5")).toBe(5)
})
it("3. should return the sum of those numbers", () => {
    expect(sum("1,2")).toBe(3)
})

it("4. should return the sum of those numbers when input has any amount of numbers", () => {
    expect(sum("1,2,3,4")).toBe(10)
})

it("5. should return the sum of those numbers when input new line and comma delimiters", () => {
    expect(sum("1\n2,3")).toBe(6)
})

it("6. should return the sum of those numbers when input has a single character custom delimiter", () => {
    expect(sum("//.\n1.2.3")).toBe(6)
})
